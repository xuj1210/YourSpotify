                ...
                <Toolbar disableGutters>
                    ...
                    >
                        <div onClick={() => router.push({
                            pathname: '/',
                            query: { token: token }
                        })} className='clickable'>YourSpotify</div>
                    </Typography>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                        ...
                        >
                            {pages.map((page) => (
                                <MenuItem key={page} onClick={() => router.push({
                                    pathname: `/top-${page.toLowerCase()}`,
                                    query: { token: token }
                                })}>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        {pages.map((page) => {
                            // console.log('pretend path: ', `/top-${page.toLowerCase()}`);
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        >
                            {settings.map((setting) => (
                                <MenuItem key={setting} onClick={() => router.push({
                                    pathname: '/'
                                })}>

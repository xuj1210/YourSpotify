...
function getArtistsString(artistsArr) {
    let retStr = artistsArr[0].name;
    for (let i = 1; i < artistsArr.length; ++i) {
        retStr += `, ${artistsArr[i].name}`;
    }
    return retStr;
}

export { getAuthURI, getAccessToken, getSpotifyData, getUserInfo, getArtistsString };